...
-- ALL implies INCLUDING INDEXES, which per the PostgreSQL docs DOES create the
-- source table's PRIMARY KEY, UNIQUE and EXCLUDE constraints on the new table,
-- under auto-generated names. Nothing needed restating. Migration
